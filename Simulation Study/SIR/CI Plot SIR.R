setwd("C://SFU//Research//Comparison//AdaptiveASMC//Results_Sim//SIR")
...
# Read the CSV files
chain1 <- read.csv("C://SFU//Research//Comparison//AdaptiveASMC//Results_Sim//SIR//AMCMC//AMCMC_SIR_chain1.csv")
chain2 <- read.csv("C://SFU//Research//Comparison//AdaptiveASMC//Results_Sim//SIR//AMCMC//AMCMC_SIR_chain2.csv")
chain3 <- read.csv("C://SFU//Research//Comparison//AdaptiveASMC//Results_Sim//SIR//AMCMC//AMCMC_SIR_chain3.csv")
chain4 <- read.csv("C://SFU//Research//Comparison//AdaptiveASMC//Results_Sim//SIR//AMCMC//AMCMC_SIR_chain4.csv")
chain5 <- read.csv("C://SFU//Research//Comparison//AdaptiveASMC//Results_Sim//SIR//AMCMC//AMCMC_SIR_chain5.csv")

chain11 <- chain1[25001: 62000, ]
chain22 <- chain2[25001: 62000, ]
chain33 <- chain3[25001: 62000, ]
chain44 <- chain4[25001: 62000, ]
chain55 <- chain5[25001: 62000, ]
...
resampled_particles1 <- read.csv("C://SFU//Research//Comparison//AdaptiveASMC//Results_Sim//SIR//ASMC_AMTM//ASMC_AMTM_SIR_1000_0.99_rsp.csv")
...
resampled_particles2 <- read.csv("C://SFU//Research//Comparison//AdaptiveASMC//Results_Sim//SIR//AASMC//AASMC_SIR_1000_0.99_rsp.csv")
...
# Ensure the Parameter column is consistent
parameter_names <- c("β", "γ", "ϕ", "S0", "I0")
parameter_levels <- unique(ci_df$Parameter)  # Assuming ci_df already has proper parameter names

ci_df$Parameter <- factor(ci_df$Parameter, levels = parameter_levels, labels = parameter_names)
ci_resampled_df1$Parameter <- factor(ci_resampled_df1$Parameter, levels = colnames(resampled_particles1), labels = parameter_names)
ci_resampled_df2$Parameter <- factor(ci_resampled_df2$Parameter, levels = colnames(resampled_particles2), labels = parameter_names)

# Combine all data frames into one
ci_all <- rbind(ci_df, ci_resampled_df1, ci_resampled_df2)

# True values
true_values <- c(β = 0.2976, γ = 1/8.5, ϕ = 100, S0 = 994, I0 = 6)
...
ggsave("CI_SIR.jpg", plot = p, width = 12, height = 8, dpi = 300)
