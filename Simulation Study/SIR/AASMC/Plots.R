setwd("C://SFU//Research//Comparison//AdaptiveASMC//Results_Sim//SIR//AASMC")
...
resampled_particles1 <- read.csv("AASMC_SIR_1000_0.99_rsp.csv")
...
ggsave("AASMC_SIR_DEN.jpeg", plot = p1, width = 12, height = 8, dpi = 300)

# plot for ASMC_MTM_SEIR

par(mfrow = c(2,1))
ess7 <- read.csv("AASMC_SIR_1000_0.99_ESS.csv")
alpha7 <- read.csv("AASMC_SIR_1000_0.99_alpha.csv")
...
# Save the plot with high resolution
ggsave("AASMC_SIR_ESS_Alpha.jpeg", plot = cplot1, width = 12, height = 8, dpi = 300)